...
class Business(Model):
    ...
    business_descripton = fields.TextField(null=True)
...
class Product(Model):
    ...
    date_punblished = fields.DatetimeField(default=datetime.utcnow)
...
user_pydanticOut = pydantic_model_creator(
    User, name="UserOut", exclude_readonly=("password", ))
...
product_pydanticIn = pydantic_model_creator(
    Product, name="ProductIn", exclude=(
        "percentage_discount", "id", "product_image", "date_posted"
    ))
